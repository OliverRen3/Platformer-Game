...
public class Map {
    ...
    Map(int level){
        ...
        Terrain top = new Terrain(0, 0, 1600, 100);
        Terrain bottom = new Terrain(0, 800, 1600, 100);
        Terrain left = new Terrain(0, 0, 100, 900);
        Terrain right = new Terrain(1500, 0, 100, 900);
